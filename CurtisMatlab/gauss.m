% ��������������������������������������������
function [r, v, r_old, v_old, ff1, ff3, gg1, gg3, ffdot1, ffdot3, ggdot1, ggdot3] = ...
...
R1, R2, R3 - the observation site position vectors at t1, t2, t3 (km)
Rho1, Rho2, Rho3 - the direction cosine vectors of the satellite at t1, t2, t3
...
r_old, v_old - the estimated state vector at the end of Algorithm 5.5 (km, km/s)
rho1_old, 
rho2_old, and
rho3_old - the values of the slant ranges at t1, t2, t3 at the beginning of iterative improvement
(Algorithm 5.6) (km)
diff1, diff2, and diff3 - the magnitudes of the differences between the
old and new slant ranges at the end of each iteration
...
while ((diff1 > tol) & (diff2 > tol) & (diff3 > tol)) & (n < nmax)
    ...
    [ffdot1, ggdot1] = fDot_and_gDot(x1, tau1, ro, a);
    [ffdot3, ggdot3] = fDot_and_gDot(x3, tau3, ro, a);
